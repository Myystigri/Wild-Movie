    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/post')) {
            ...
            if (rtrim($pathinfo, '/') === '/post') {
                ...
                return array (  '_controller' => 'FrontendBundle\\Controller\\PostController::indexAction',  '_route' => 'post_index',);
            }
            not_post_index:
            ...
            if (preg_match('#^/post/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'post_show')), array (  '_controller' => 'FrontendBundle\\Controller\\PostController::showAction',));
            }
            not_post_show:
            ...
            if ($pathinfo === '/post/new') {
                ...
                return array (  '_controller' => 'FrontendBundle\\Controller\\PostController::newAction',  '_route' => 'post_new',);
            }
            not_post_new:
            ...
            if (preg_match('#^/post/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'post_edit')), array (  '_controller' => 'FrontendBundle\\Controller\\PostController::editAction',));
            }
            not_post_edit:
            ...
            if (preg_match('#^/post/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'post_delete')), array (  '_controller' => 'FrontendBundle\\Controller\\PostController::deleteAction',));
            }
            not_post_delete:
